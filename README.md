...
- [ ] What is React JS and what problems does it try and solve? React JS is the view layer of the MVC design pattern. It solves the problem of website re-renders by only rendering the small changes made, rather than the whole website for each small change.
- [ ] What does it mean to _think_ in react?
To think in react means to split your aplication into components.
- [ ] Describe state.
Its Data that is monitored by react waitng for a command to rerendor
- [ ] Describe props.
used to customize components when there being created while giving it new parameters.
## Project Set Up
